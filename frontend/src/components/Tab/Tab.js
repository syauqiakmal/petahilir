...
const Tab = () => {
  ...
  const content = {
    ...
    Nikel: {
        ...
        sentimentApiUrl: "https://api.awario.com/v1.0/alerts/78518/insights/total/sentiment?access_token=KTOdiuA6BzXcY0Z0&date_from=2020-01-01",
        apiUrl: "https://api.awario.com/v1.0/alerts/78518/mentions?access_token=KTOdiuA6BzXcY0Z0&sort_by=reach&sort_order=desc&limit=6"
      },
      Bauksit: {
        ...
        sentimentApiUrl:"https://api.awario.com/v1.0/alerts/78532/insights/total/sentiment?access_token=KTOdiuA6BzXcY0Z0&date_from=2020-01-01",
        apiUrl:"https://api.awario.com/v1.0/alerts/78532/mentions?access_token=KTOdiuA6BzXcY0Z0&sort_by=reach&sort_order=desc&limit=6"
      },
      Kobalt: {
        ...
        PerubahanLingkungan: '',
        label: 'Kobalt',
        sentimentApiUrl:"https://api.awario.com/v1.0/alerts/78525/insights/total/sentiment?access_token=KTOdiuA6BzXcY0Z0&date_from=2020-01-01",
        apiUrl:"https://api.awario.com/v1.0/alerts/78525/mentions?access_token=KTOdiuA6BzXcY0Z0&sort_by=reach&sort_order=desc&limit=6"
      },
      PasirKwarsa: {
        ...
        image: KuarsaMap,
        label: 'Pasir Kuarsa',
        sentimentApiUrl:"https://api.awario.com/v1.0/alerts/78533/insights/total/sentiment?access_token=KTOdiuA6BzXcY0Z0&date_from=2020-01-01",
        apiUrl:"https://api.awario.com/v1.0/alerts/78533/mentions?access_token=KTOdiuA6BzXcY0Z0&sort_by=reach&sort_order=desc&limit=6"
      },
  };
